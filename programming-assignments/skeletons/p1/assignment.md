...
*Out on Thu Sep 28, 2023. Due on Wed Oct 18 2023 6:00pm.*
...
This repo contains a basic template that should help you get started. You can download .zip of the repo: ([p1.zip](https://www.students.cs.ubc.ca/~cs-447/23Sep/p1.zip)).
